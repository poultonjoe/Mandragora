        ...
        <?php else : ?>
            <form class="form comments-form" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                <?php if ( is_user_logged_in() ) : ?>
                    <p class="comments-logged-in-as"><?php pll_e("Logged in as", "mandragora"); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account"><?php pll_e("Log out", "mandragora"); ?> &raquo;</a></p>
                <?php else : ?>
                    <div class="form-field">
                        <label class="form-label form-label-hidden" for="author"><?php pll_e("Name", "mandragora"); ?> <?php if ($req) echo "(required)"; ?></label>
                    ...
                    <div class="form-field">
                        <label class="form-label form-label-hidden" for="email"><?php pll_e("Email address", "mandragora"); ?> <?php if ($req) echo "(required)"; ?></label>
